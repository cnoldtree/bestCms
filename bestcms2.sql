...
--
-- Host: 127.0.0.1
-- Generation Time: 2014-08-26 15:36:58
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `bc_access` (
...
CREATE TABLE IF NOT EXISTS `bc_adma` (
...
--
-- 表的结构 `bc_alipay_config`
--

CREATE TABLE IF NOT EXISTS `bc_alipay_config` (
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_areply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_behavior` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_classify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_company_staff`
--

CREATE TABLE IF NOT EXISTS `bc_company_staff` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_diymen_class`
--

CREATE TABLE IF NOT EXISTS `bc_diymen_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_diymen_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_dream` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bc_dream` (`id`, `title`, `content`) VALUES
...
CREATE TABLE IF NOT EXISTS `bc_estate` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_estate_album`
--

CREATE TABLE IF NOT EXISTS `bc_estate_album` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
...
--
-- 表的结构 `bc_estate_expert`
--

CREATE TABLE IF NOT EXISTS `bc_estate_expert` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `title` varchar(50) NOT NULL,
...
--
-- 表的结构 `bc_estate_housetype`
--

CREATE TABLE IF NOT EXISTS `bc_estate_housetype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_estate_impress`
--

CREATE TABLE IF NOT EXISTS `bc_estate_impress` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `title` varchar(50) NOT NULL,
  `sort` int(11) NOT NULL,
...
--
-- 表的结构 `bc_estate_impress_add`
--

CREATE TABLE IF NOT EXISTS `bc_estate_impress_add` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_estate_son` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `token` varchar(50) NOT NULL,
  `title` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_files` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `bc_flash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `img` char(255) NOT NULL,
  `url` char(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_function` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bc_function` (`id`, `gid`, `usenum`, `name`, `funname`, `info`, `isserve`, `status`) VALUES
...
(43, 4, 0, '全景', 'panorama', '全景看房，看车', 2, 1),
(44, 4, 0, '婚庆喜帖', 'wedding', '婚庆喜帖', 2, 1),
(45, 4, 0, '投票', 'vote', '投票模块', 2, 1),
(46, 4, 0, '微房产', 'estate', '微房产', 1, 1),
(47, 4, 0, '大转盘', 'lottery', '大转盘抽奖', 2, 1);
...
CREATE TABLE IF NOT EXISTS `bc_home` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(30) NOT NULL,
...
--
-- 表的结构 `bc_home_background`
--

CREATE TABLE IF NOT EXISTS `bc_home_background` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_host` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL,
...
--
-- 表的结构 `bc_host_list_add`
--

CREATE TABLE IF NOT EXISTS `bc_host_list_add` (
...
CREATE TABLE IF NOT EXISTS `bc_host_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL,
  `wecha_id` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_indent` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyword` char(255) NOT NULL,
  `pid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_leave` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_lottery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_lottery_cheat`
--

CREATE TABLE IF NOT EXISTS `bc_lottery_cheat` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_lottery_record`
--

CREATE TABLE IF NOT EXISTS `bc_lottery_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lid` int(11) NOT NULL,
...
--
-- 表的结构 `bc_member_card_contact`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `bc_member_card_coupon`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_member_card_create`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_create` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cardid` int(10) NOT NULL DEFAULT '0',
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `bc_member_card_exchange`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_exchange` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_member_card_info`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `info` varchar(200) NOT NULL,
...
--
-- 表的结构 `bc_member_card_integral`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_integral` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cardid` int(10) NOT NULL DEFAULT '0',
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
--
-- 表的结构 `bc_member_card_notice`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_notice` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `cardid` int(10) NOT NULL DEFAULT '0',
...
--
-- 表的结构 `bc_member_card_set`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `bc_member_card_sign`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_sign` (
  `id` int(11) NOT NULL,
  `token` varchar(50) NOT NULL,
  `wecha_id` varchar(50) NOT NULL,
...
--
-- 表的结构 `bc_member_card_use_record`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_use_record` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_member_card_vip`
--

CREATE TABLE IF NOT EXISTS `bc_member_card_vip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cardid` int(10) NOT NULL DEFAULT '0',
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_nearby_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_node` (
...
INSERT INTO `bc_node` (`id`, `name`, `title`, `status`, `remark`, `pid`, `level`, `data`, `sort`, `display`) VALUES
...
--
-- 表的结构 `bc_ordering_class`
--

CREATE TABLE IF NOT EXISTS `bc_ordering_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `bc_ordering_set`
--

CREATE TABLE IF NOT EXISTS `bc_ordering_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `keyword` varchar(10) NOT NULL,
  `title` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `keyword` varchar(60) NOT NULL,
  `info` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_panorama` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL DEFAULT '',
  `name` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `bc_photo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(20) NOT NULL,
  `picurl` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_photo_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
  `title` varchar(20) NOT NULL,
...
--
-- 表的结构 `bc_product_cart`
--

CREATE TABLE IF NOT EXISTS `bc_product_cart` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL DEFAULT '',
  `wecha_id` varchar(60) NOT NULL DEFAULT '',
...
--
-- 表的结构 `bc_product_cart_list`
--

CREATE TABLE IF NOT EXISTS `bc_product_cart_list` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_product_cat` (
...
--
-- 表的结构 `bc_product_diningtable`
--

CREATE TABLE IF NOT EXISTS `bc_product_diningtable` (
  `id` mediumint(4) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `bc_reply` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `wecha_id` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_reply_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_requestdata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `year` int(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_reservation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL,
  `keyword` varchar(50) NOT NULL,
  `title` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_reservebook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rid` int(11) NOT NULL,
  `token` varchar(50) NOT NULL,
  `wecha_id` varchar(50) NOT NULL,
...
INSERT INTO `bc_role` (`id`, `name`, `pid`, `status`, `sort`, `remark`) VALUES
(5, '超级管理员', 0, 1, 0, ''),
(6, '演示组', 0, 1, 0, ''),
(9, '普通会员', 0, 1, 0, '');
...
CREATE TABLE IF NOT EXISTS `bc_role_user` (
...
CREATE TABLE IF NOT EXISTS `bc_selfform` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL DEFAULT '',
  `name` varchar(100) NOT NULL DEFAULT '',
  `keyword` varchar(100) NOT NULL DEFAULT '',
...
--
-- 表的结构 `bc_selfform_input`
--

CREATE TABLE IF NOT EXISTS `bc_selfform_input` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bc_selfform_value`
--

CREATE TABLE IF NOT EXISTS `bc_selfform_value` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `formid` int(10) NOT NULL DEFAULT '0',
  `wecha_id` varchar(50) NOT NULL DEFAULT '',
...
--
-- 表的结构 `bc_site_plugmenu`
--

CREATE TABLE IF NOT EXISTS `bc_site_plugmenu` (
  `token` varchar(60) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `bc_snccode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(1) NOT NULL,
  `status` int(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_system_info` (
  `lastsqlupdate` int(10) NOT NULL,
  `version` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `bc_system_info`
--

INSERT INTO `bc_system_info` (`lastsqlupdate`, `version`) VALUES
(1388242380, '1388220600');
...
CREATE TABLE IF NOT EXISTS `bc_taobao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_text` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `keyword` char(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_token_open` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
--
-- 转存表中的数据 `bc_token_open`
--

INSERT INTO `bc_token_open` (`id`, `uid`, `token`, `queryname`) VALUES
(1, 1, 'menbap1409058408', 'tianqi,qiushi,jishuan,langdu,jiankang,kuaidi,xiaohua,changtoushi,peiliao,liaotian,mengjian,yuyinfanyi,huoche,gongjiao,shenfenzheng,shouji,yinle,fujin,choujiang,taobao,userinfo,fanyi,api,suanming,baike,caipiao,choujiang,gua2,shouye,adma,huiyuanka,shenhe,geci,,host_kev,,diyform,dx,shop,etuan,diymen_set,panorama,wedding,vote,estate,lottery');

-- --------------------------------------------------------

--
-- 表的结构 `bc_update_record`
--

CREATE TABLE IF NOT EXISTS `bc_update_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `bc_update_record`
--

INSERT INTO `bc_update_record` (`id`, `msg`, `type`, `time`) VALUES
...
(7, '2014年12月升级包7', 'upgrade', 1388110440),
(8, '2014年12月补丁1', 'upgrade', 1388110500),
(9, '2014年12月补丁2', 'upgrade', 1388110560),
(10, '2014年12月补丁2', 'upgrade', 1388220600);

-- --------------------------------------------------------

--
-- 表的结构 `bc_upyun_attachement`
--

CREATE TABLE IF NOT EXISTS `bc_upyun_attachement` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
INSERT INTO `bc_user` (`id`, `username`, `password`, `role`, `status`, `remark`, `last_login_time`, `last_login_ip`, `last_location`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 5, 1, '', 1409058488, '127.0.0.1', '');
...
CREATE TABLE IF NOT EXISTS `bc_userinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `wecha_id` varchar(60) NOT NULL,
  `wechaname` varchar(60) NOT NULL,
...
INSERT INTO `bc_users` (`id`, `gid`, `username`, `mp`, `password`, `email`, `createtime`, `lasttime`, `status`, `createip`, `lastip`, `diynum`, `activitynum`, `card_num`, `card_create_status`, `wechat_card_num`, `money`, `viptime`, `connectnum`, `lastloginmonth`, `attachmentsize`) VALUES
(1, 4, 'user', '', 'ee11cbb19052e40b07aac0ca060c23ee', 'user@ts.com', '1409058203', '1409059448', '1', '127.0.0.1', '127.0.0.1', 0, 0, 0, 0, 1, 0, '1914163200', 0, 8, 0);
...
--
-- 转存表中的数据 `bc_user_group`
--

INSERT INTO `bc_user_group` (`id`, `name`, `diynum`, `connectnum`, `iscopyright`, `activitynum`, `price`, `statistics_user`, `create_card_num`, `wechat_card_num`, `status`) VALUES
(1, 'vip0', 2000, 2000, 1, 0, 0, 0, 10, 0, 1),
(2, 'VIP1', 3000, 3000, 1, 2, 1, 0, 50, 1, 1),
(3, 'vip2', 40000, 40000, 1, 4, 50, 0, 80, 1, 1),
(4, 'vip3', 50000, 500000, 1, 10, 180, 0, 1000, 10, 1);

-- --------------------------------------------------------

--
-- 表的结构 `bc_user_request`
--

CREATE TABLE IF NOT EXISTS `bc_user_request` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `uid` varchar(32) NOT NULL,
  `keyword` varchar(100) NOT NULL,
...
--
-- 表的结构 `bc_voiceresponse`
--

CREATE TABLE IF NOT EXISTS `bc_voiceresponse` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `createtime` varchar(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_vote` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
  `keyword` varchar(60) NOT NULL,
  `token` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_vote_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_vote_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_weather` (
...
INSERT INTO `bc_weather` (`id`, `code`, `name`) VALUES
(1, '101010100', '北京'),
(2, '101010200', '海淀'),
(3, '101010400', '顺义'),
(4, '101010500', '怀柔'),
...
CREATE TABLE IF NOT EXISTS `bc_wecha_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `wecha_id` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bc_wedding` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
  `keyword` varchar(60) NOT NULL,
...
--
-- 表的结构 `bc_wedding_info`
--

CREATE TABLE IF NOT EXISTS `bc_wedding_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fid` int(11) NOT NULL,
  `name` varchar(60) NOT NULL,
  `phone` varchar(12) NOT NULL,
...
--
-- 表的结构 `bc_wehcat_member_enddate`
--

CREATE TABLE IF NOT EXISTS `bc_wehcat_member_enddate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `openid` varchar(60) NOT NULL,
  `enddate` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `bc_wxuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
INSERT INTO `bc_wxuser` (`id`, `uid`, `wxname`, `wxid`, `weixin`, `headerpic`, `token`, `province`, `color_id`, `city`, `qq`, `wxfans`, `typeid`, `typename`, `tongji`, `allcardnum`, `cardisok`, `yetcardnum`, `totalcardnum`, `createtime`, `tpltypeid`, `updatetime`, `tpltypename`, `tpllistid`, `tpllistname`, `tplcontentid`, `tplcontentname`) VALUES
(1, 1, '长沙民政学院湖南大运会', 'gh_d3df8f3cf4ba', 'csmyhndyh', './tpl/User/default/common/images/portrait.jpg', 'menbap1409058408', '湖南', 0, '长沙', '1409058408@yourdomain.com', 0, 8, '服务', '', 0, 0, 0, 0, '1409058417', '1', '1409058417', 'ty_index', '1', 'yl_list', '1', 'ktv_content');
